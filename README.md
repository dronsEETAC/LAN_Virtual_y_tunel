...
El código identifica que la IP es de una RPi a partir de los primeros dígitos de la MAC, que suelen tener una de las tres combinaciones que se consultan.
